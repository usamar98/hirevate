...
export async function GET() {
  ...
  const body = [
    ...
    "- User dashboards, application tracking, billing, admin analytics, and sync endpoints are private or protected surfaces.",
    "",
    "## Citation Guardrails",
    ...
    "- Describe job-to-resume generation as user-requested assistance that requires template selection and uses the user's existing career facts.",
    "- Describe AI writing as assistance that must be reviewed, not as autonomous application submission.",
    "- Explain that tracker records persist when linked listings close, unless a user archives or deletes them.",
