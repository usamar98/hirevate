    ...
    sections: [
      {
        ...
        text: [pricingSummary, "The selected price and interval are shown before payment. Stripe processes card details and recurring charges. A subscription renews monthly or annually until cancellation."]
      },
      {
        title: "Cancellation",
