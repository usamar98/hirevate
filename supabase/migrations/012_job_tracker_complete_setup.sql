-- Complete self-contained job tracker lifecycle setup.
-- Safe when earlier tracker migrations failed, rolled back, or partially completed.
-- This migration is idempotent and uses named PostgreSQL function delimiters.
